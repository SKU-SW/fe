      ...
      <section className="rounded-xl border border-slate-800 bg-slate-900 p-5">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-sm text-white placeholder-slate-500 focus:border-red-500 focus:outline-none focus:ring-1 focus:ring-red-500"
          />
          <button
            type="button"
            onClick={submit}
        ...
        <div className="mb-4 flex items-center justify-between">
          ...
          {words.length > 0 && (
            <button
              ...
              className="flex items-center gap-1 rounded-lg px-2 py-1 text-xs text-slate-400 hover:bg-slate-800 hover:text-red-400 transition-colors"
            >
          ...
          <div className="w-full max-w-sm rounded-xl border border-slate-800 bg-slate-900 p-5 shadow-xl">
            ...
            <div className="mt-4 flex justify-end gap-2">
              <button
                ...
                className="rounded-lg px-3 py-1.5 text-sm text-slate-300 hover:bg-slate-800 transition-colors"
              >
                취소
              </button>
              <button
