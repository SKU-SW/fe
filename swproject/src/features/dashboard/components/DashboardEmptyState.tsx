...
export function DashboardEmptyState() {
  return (
    <div className="flex min-h-[480px] flex-col items-center justify-center px-6 text-center">
      ...
      <Link
        to="/character"
        className="mt-6 inline-flex items-center gap-2 rounded-lg bg-brand px-5 py-2.5 text-base font-semibold text-content-inverse transition-colors hover:bg-brand-hover"
      >
        AI 캐릭터로 이동
